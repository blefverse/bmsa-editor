...
////////////////////////////////////////////////////
//
//  September 22, 2003 modified by Milenko Mitrovic <dcoder@dsp-worx.de>
//  -removed Synchrinze from the TimerThread since it doen´t
//   work in DShow Applications
...
begin
  repeat
    if WaitForSingleObject(FStop, FInterval) = WAIT_TIMEOUT then FOwner.DoTimer;
  until Terminated;
end;
